...
(function (root, undefined) {
  ...
  // quick reference for
  var primitives = [_.isString, _.isBoolean, _.isNumber, _.isDate, _.isNull, _.isRegExp, _.isUndefined];
  ...
  Mingo.Query.prototype = {
    ...
    _processOperator: function _processOperator(field, operator, value) {
     ...
     */
    find: function find(collection, projection) {
  ...
  if (nodeEnabled) {
    ...
    Mingo.Stream = function (query, options) {
      ...
      if (!(this instanceof Mingo.Stream)) return new Mingo.Stream(query, options);
  ...
  Mingo.Cursor = function (collection, query, projection) {
    ...
    if (!(this instanceof Mingo.Cursor)) return new Mingo.Cursor(collection, query, projection);
  ...
  Mingo.Aggregator.prototype = {
     ...
     * @returns {Array}
     */
    run: function run(collection, query) {
  ...
  var aggregateOperators = _.extend({}, arrayOperators, arithmeticOperators, booleanOperators, comparisonOperators, conditionalOperators, dateOperators, literalOperators, setOperators, stringOperators, variableOperators);
  ...
  function encode(value) {
    if (_.isNull(value)) {
      ...
      switch (type) {
        ...
        case "Array":
          return "a|" + JSON.stringify(_.map(value, function (v) {
            return encode(v);
          }));
        case "Object":
          return "o|" + JSON.stringify(_.mapObject(value, function (v) {
            return encode(v);
          }));
        default:
          return type + "|" + JSON.stringify(_.mapObject(value, function (v) {
            return encode(v);
          }));
      }
    }
