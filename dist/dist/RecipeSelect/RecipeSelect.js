...
exports.SelectRecipeHtml = function (req, res, next) {
   ...
   rtnStr += multiline(function () {/*
                                    ...
                                    */});
   //creates Filter Query, without allergy
   ...
   //creates Filter Query, with allergy
   if (IDAllergyGroup != 'null' && IDAllergyGroup != undefined) {
      if (FilterOption === 'Ingredient') {
         FilterQuery = 'SELECT tblRecipe.IDRecipe, RecipeTitle, Description, ImageName FROM tblRecipe, tblImage, tblRecipeImage, tblIngredient, tblRecipeIngredient, tblIngredientAllergyGroups WHERE tblRecipeImage.IDRecipe = tblRecipe.IDRecipe AND tblRecipeImage.IDImage = tblImage.IDImage AND MainImage = true AND tblRecipeIngredient.IDRecipe = tblRecipe.IDRecipe AND tblRecipeIngredient.IDIngredient = tblIngredient.IDIngredient AND IngredientName = ' + connection.escape(FilterData) + 'AND tblIngredientAllergyGroups.IDIngredient = tblIngredient.IDIngredient';
      } else if (FilterOption === 'ServingSize') {
         var FilterQuery = 'SELECT tblRecipe.IDRecipe, RecipeTitle, Description, ImageName FROM tblRecipe, tblImage, tblRecipeImage, tblIngredient, tblRecipeIngredient, tblIngredientAllergyGroups WHERE tblRecipeImage.IDRecipe = tblRecipe.IDRecipe AND tblRecipeImage.IDImage = tblImage.IDImage AND MainImage = true AND ServingSize = ' + connection.escape(FilterData) + 'AND tblRecipeIngredient.IDRecipe = tblRecipe.IDRecipe AND tblRecipeIngredient.IDIngredient = tblIngredient.IDIngredient AND tblIngredientAllergyGroups.IDIngredient = tblIngredient.IDIngredient';
      } else if (FilterOption === 'Cuisine') {
         var FilterQuery = 'SELECT tblRecipe.IDRecipe, RecipeTitle, Description, ImageName FROM tblRecipe, tblImage, tblRecipeImage, tblIngredient, tblRecipeIngredient, tblIngredientAllergyGroups WHERE tblRecipeImage.IDRecipe = tblRecipe.IDRecipe AND tblRecipeImage.IDImage = tblImage.IDImage AND MainImage = true AND Cuisine = ' + connection.escape(FilterData) + 'AND tblRecipeIngredient.IDRecipe = tblRecipe.IDRecipe AND tblRecipeIngredient.IDIngredient = tblIngredient.IDIngredient AND tblIngredientAllergyGroups.IDIngredient = tblIngredient.IDIngredient';
      } else if (FilterOption === 'PrepTime') {
         var FilterQuery = 'SELECT tblRecipe.IDRecipe, RecipeTitle, Description, ImageName FROM tblRecipe, tblImage, tblRecipeImage, tblIngredient, tblRecipeIngredient, tblIngredientAllergyGroups WHERE tblRecipeImage.IDRecipe = tblRecipe.IDRecipe AND tblRecipeImage.IDImage = tblImage.IDImage AND MainImage = true AND TimePrep = ' + connection.escape(FilterData) + 'AND tblRecipeIngredient.IDRecipe = tblRecipe.IDRecipe AND tblRecipeIngredient.IDIngredient = tblIngredient.IDIngredient AND tblIngredientAllergyGroups.IDIngredient = tblIngredient.IDIngredient';
      } else if (FilterOption === 'Type') {
         var FilterQuery = 'SELECT tblRecipe.IDRecipe, RecipeTitle, Description, ImageName FROM tblRecipe, tblImage, tblRecipeImage, tblIngredient, tblRecipeIngredient, tblIngredientAllergyGroups WHERE tblRecipeImage.IDRecipe = tblRecipe.IDRecipe AND tblRecipeImage.IDImage = tblImage.IDImage AND MainImage = true AND Types = ' + connection.escape(FilterData) + 'AND tblRecipeIngredient.IDRecipe = tblRecipe.IDRecipe AND tblRecipeIngredient.IDIngredient = tblIngredient.IDIngredient AND tblIngredientAllergyGroups.IDIngredient = tblIngredient.IDIngredient';
      } else if (FilterOption === 'SearchTag') {
         var FilterQuery = 'SELECT tblRecipe.IDRecipe, RecipeTitle, Description, ImageName FROM tblRecipe, tblImage, tblRecipeImage, tblIngredient, tblRecipeIngredient, tblIngredientAllergyGroups, tblRecipeSearchTag, tblSearchTag WHERE tblRecipeImage.IDRecipe = tblRecipe.IDRecipe AND tblRecipeImage.IDImage = tblImage.IDImage AND MainImage = true AND tblRecipeSearchTag.IDRecipe = tblRecipe.IDRecipe AND tblRecipeSearchTag.IDSearchTag = tblSearchTag.IDSearchTag AND SearchTagName = ' + connection.escape(FilterData) + 'AND tblRecipeIngredient.IDRecipe = tblRecipe.IDRecipe AND tblRecipeIngredient.IDIngredient = tblIngredient.IDIngredient AND tblIngredientAllergyGroups.IDIngredient = tblIngredient.IDIngredient';
      }
      // for(var i =0; i<IDAllergyGroup.length; i++){
      //   FilterQuery =+ +'AND IDAllergyGroup ='  + connection.escape(IDAllergyGroup);
      // }
   }
...
//# sourceMappingURL=RecipeSelect.js.map
//# sourceMappingURL=RecipeSelect.js.map