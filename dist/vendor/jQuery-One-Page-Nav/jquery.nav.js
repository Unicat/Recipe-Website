...
!function (t, n, i, s) {
  var e = function e(s, _e) {
    this.elem = s, this.$elem = t(s), this.options = _e, this.metadata = this.$elem.data("plugin-options"), this.$win = t(n), this.sections = {}, this.didScroll = !1, this.$doc = t(i), this.docHeight = this.$doc.height();
    ...
    }, adjustNav: function adjustNav(t, n) {
      ...
      var t,
          n = this;n.$win.on("scroll.onePageNav", function () {
        n.didScroll = !0;
      ...
      var n = null,
          i = Math.round(this.$win.height() * this.config.scrollThreshold);for (var s in this.sections) {
      ...
      var t,
          ...
          i = this.getSection(n);null !== i && (t = this.$elem.find('a[href$="#' + i + '"]').parent(), t.hasClass(this.config.currentClass) || (this.adjustNav(this, t), this.config.scrollChange && this.config.scrollChange(t)));
    }, scrollTo: function scrollTo(n, i) {
      var s = t(n).offset().top;t("html, body").animate({ scrollTop: s }, this.config.scrollSpeed, this.config.easing, i);
...
//# sourceMappingURL=jquery.nav.js.map