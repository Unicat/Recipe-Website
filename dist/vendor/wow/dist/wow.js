...
(function () {
  var t,
    ...
    function t() {}return t.prototype.extend = function (t, e) {
      ...
      var o;return null == e && (e = !1), null == n && (n = !1), null == i && (i = null), null != document.createEvent ? (o = document.createEvent("CustomEvent"), o.initCustomEvent(t, e, n, i)) : null != document.createEventObject ? (o = document.createEventObject(), o.eventType = t) : o.eventName = t, o;
    ...
    function t() {
      ...
      var e, n, i, o, r;for (r = this.keys, e = i = 0, o = r.length; i < o; e = ++i) {
        if (n = r[e], n === t) return this.values[e];
      }
    }, t.prototype.set = function (t, e) {
      var n, i, o, r, s;for (s = this.keys, n = o = 0, r = s.length; o < r; n = ++o) {
    ...
    function o(t) {
      ...
      var e, n, i, o;if (this.stopped = !1, this.boxes = function () {
        var t, n, i, o;for (i = this.element.querySelectorAll("." + this.config.boxClass), o = [], t = 0, n = i.length; t < n; t++) {
          e = i[t], o.push(e);
        }return o;
      }.call(this), this.all = function () {
        var t, n, i, o;for (i = this.boxes, o = [], t = 0, n = i.length; t < n; t++) {
          e = i[t], o.push(e);
        }return o;
      }.call(this), this.boxes.length) if (this.disabled()) this.resetStyle();else for (o = this.boxes, n = 0, i = o.length; n < i; n++) {
        ...
        return function (e) {
          var n, i, o, r, s;for (s = [], n = 0, i = e.length; n < i; n++) {
            r = e[n], s.push(function () {
              var t, e, n, i;for (n = r.addedNodes || [], i = [], t = 0, e = n.length; t < e; t++) {
      ...
      var t, e, n, i, o;for (i = this.boxes, o = [], e = 0, n = i.length; e < n; e++) {
      ...
      var n, i, o, r;i = [];for (n in e) {
        o = e[n], t["" + n] = o, i.push(function () {
          var e, i, s, l;for (s = this.vendors, l = [], e = 0, i = s.length; e < i; e++) {
            r = s[e], l.push(t["" + r + n.charAt(0).toUpperCase() + n.substr(1)] = o);
          }return l;
        }.call(this));
      }return i;
    }, o.prototype.vendorCSS = function (t, e) {
      var n, o, r, s, l, a;for (l = i(t), s = l.getPropertyCSSValue(e), r = this.vendors, n = 0, o = r.length; n < o; n++) {
      ...
      var t;if (this.scrolled && (this.scrolled = !1, this.boxes = function () {
        var e, n, i, o;for (i = this.boxes, o = [], e = 0, n = i.length; e < n; e++) {
      ...
      var e, n, i, o, r;return n = t.getAttribute("data-wow-offset") || this.config.offset, r = window.pageYOffset, o = r + Math.min(this.element.clientHeight, this.util().innerHeight()) - n, i = this.offsetTop(t), e = i + t.clientHeight, i <= o && e >= r;
