...
exports.RecipeHtml = function(req, res) {
    ...
    function Image(IDRecipe, req, res){ //function to retrieve the image data
    ...
    function Title(IDRecipe, ImageList, req, res) { //function to retrieve the header data
...
" class="btn btn-sm btn-default">Convert Serving Size</a>
    ...
    function Ingredient(IDRecipe, rtnStr, ServingSize, ImageList, req, res) { //function to retrieve the ingredient data
    ...
    function Equipment(IDRecipe, rtnStr, ImageList, req, res) { //function to retrieve the equipment data
    ...
    function Method(IDRecipe, rtnStr, ImageList, req, res) { //function to retrieve method data
...
.png" alt="" data-no-retina>
    ...
    function Comment(IDRecipe, rtnStr, req, res) { //function to retrieve the comment data
